...
export default class TableViewItemComponent extends PureComponent {
    constructor(props) {
        ...
        this.columnsRenderers = {
            ...
            contentType: this.renderContentTypeCell.bind(this),
            ...
            locationId: this.renderLocationIdCell.bind(this),
            locationRemoteId: this.renderLocationRemoteIdCell.bind(this),
            objectId: this.renderObjectIdCell.bind(this),
            objectRemoteId: this.renderObjectRemoteIdCell.bind(this),
        };
    }
     ...
     */
    handleEdit() {
        const { id, mainLanguageCode, currentVersion } = this.props.item.content;
